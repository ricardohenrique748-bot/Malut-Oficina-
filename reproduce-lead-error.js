...
async function run() {
    try {
        ...
        console.log("Admin found:", systemUser ? systemUser.id : "null");

        const responsibleUser = systemUser || await prisma.user.findFirst();
        console.log("Responsible User:", responsibleUser ? responsibleUser.id : "null");
        ...
        const customer = await prisma.customer.create({
            data: {
                name: "Test Lead Error JS",
                email: `test_error_js_${Date.now()}@test.com`,
                phone: "11999999999"
            }
        });
